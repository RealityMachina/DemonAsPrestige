    ...
    public static class Helpers {
        ...
        public static void RegisterClass(BlueprintCharacterClass ClassToRegister)
        {
            ...
            allClasses.Sort(delegate (BlueprintCharacterClassReference x, BlueprintCharacterClassReference y)
            {
                ...
                BlueprintCharacterClass tClassY = ResourcesLibrary.TryGetBlueprint<BlueprintCharacterClass>(y.guid);
                bool flag = tClass != null && tClassY != null;
                int result;
                if (flag)
                {
                    bool flag2 = tClass.PrestigeClass != tClassY.PrestigeClass;
                    if (flag2)
                    {
                        result = (tClass.PrestigeClass ? 1 : -1);
                    }
                    else
                    {
                        result = tClass.NameSafe().CompareTo(tClassY.NameSafe());
                    }
                }
                else
                {
