...
namespace DemonAsPrestige
{
    public class Main
    {
        ...
        private static void OnGUI(UnityModManager.ModEntry modEntry)
        {
            ...
            settings.NoRequirement = GUILayout.Toggle(settings.NoRequirement, "Check this to remove the Legend and main character requirement for Demonic Hunter. This will very likely break things.", options);
